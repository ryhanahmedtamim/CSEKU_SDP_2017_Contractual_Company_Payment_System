...
public class Login extends AppCompatActivity {
   ...
   /* void contractOfClient()
    {
        sequestQueue = Volley.newRequestQueue(this);
        String  mainUrl = sharedpreferences.getString(domainName, "");
        final String myUrl = mainUrl+"/?url=mobile/active_contract_of_client/"+sharedpreferences.getString(ID, "")
                +"/"+sharedpreferences.getString(Username, "")+"/"+sharedpreferences.getString(Password, "");
